...
public class PageSpeedInsightDesktopTest 
{
	...
	{
		{
			...
			List<WebElement> elements1 = driver.findElements(By.xpath("//input[@id='"+id1+"']/following-sibling::div[@class='OyzgL']/div[@class='PZeSbe']/span[@class='h1llh']/a"));
